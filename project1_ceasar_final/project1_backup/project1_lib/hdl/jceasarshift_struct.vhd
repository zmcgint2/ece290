-- VHDL Entity project1_lib.jceasarshift.symbol
--
-- Created:
--          by - jschen3.ews (gelib-057-18.ews.illinois.edu)
--          at - 13:11:19 10/21/13
--
...
--
-- VHDL Architecture project1_lib.jceasarshift.struct
--
-- Created:
--          by - jschen3.ews (gelib-057-18.ews.illinois.edu)
--          at - 13:11:19 10/21/13
...
BEGIN
   ...
   -- ModuleWare code(v1.9) for instance 'U_32' of 'gnd'
   dout19 <= '0';
   ...
   -- ModuleWare code(v1.9) for instance 'U_28' of 'inv'
   dout16 <= NOT(s19);
   ...
   -- ModuleWare code(v1.9) for instance 'U_33' of 'or'
   dout20 <= B7greaterA7 OR s22;
